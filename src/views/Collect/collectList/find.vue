<template>
  <div class="findlist" v-for="item in homestaylistData" :key="item">
    ...
    <div class="list-3">
      ...
      <span class="list-3text">avdfg</span>
      <div class="praise">
...
import {homestaylist} from "../../../utils/api";
...
export default {
  ...
  mounted() {
    this.gethomestaylistData();
  },
  methods: {
    async gethomestaylistData() {
      const res = await homestaylist();
      this.homestaylistData = res.result;
      console.log(this.homestaylistData);
    }
  }
}
</script>
