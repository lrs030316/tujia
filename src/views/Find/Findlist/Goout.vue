<template>
  <div class="findlist" v-for="item in gooutlistData" :key="item">
    ...
    <div class="list-3">
      ...
      <span class="list-3text">asdfg</span>
      <div class="praise">
...
import {gooutlist} from "../../../utils/api";
...
export default {
  ...
  mounted() {
    this.getgooutlistData();
  },
  methods: {
    async getgooutlistData() {
      const res = await gooutlist();
      this.gooutlistData = res.result;
      console.log(this.gooutlistData);
    }
  }
}
</script>
