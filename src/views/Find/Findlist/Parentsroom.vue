<template>
  <div class="findlist" v-for="item in parentsroomlistData" :key="item">
    ...
    <div class="list-3">
      ...
      <span class="list-3text">abcdef</span>
      <div class="praise">
...
import {parentsroomlist} from "../../../utils/api";
...
export default {
  ...
  mounted() {
    this.getparentsroomlistData();
  },
  methods: {
    async getparentsroomlistData() {
      const res = await parentsroomlist();
      this.parentsroomlistData = res.result;
      console.log(this.parentsroomlistData);
    }
  }
}
</script>
